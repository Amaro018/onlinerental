		...
		<tr>
			...
			<td>
				<form mmethod="POST" action="view_pending_user_acc.php">
					...
					<a onclick="are you sure?" class="btn btn-primary text-light" href="pending_request.php?email='. $row['email'] .'">Accept</a>
