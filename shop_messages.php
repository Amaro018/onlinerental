...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-8 col-lg-10" id="shop_messages" style="background-color: rgba(0, 123, 255, 0.1)"></div>
		</div>
	</div>

<script src="function/shop_dashboard/main_function.js"></script>
<script src="function/shop_dashboard/shop_function/messages_all_function.js"></script>
