...
<html>
<head>
	<title>Shop Item Management</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-8 col-lg-10" id="shop_item_management" style="background-color: rgba(0, 123, 255, 0.1)"></div>
		</div>
	</div>

	<!-- hidden modal -->
	<div class="container-fluid">
		<div id="item_management_modals"></div>
	</div>

<script src="function/shop_dashboard/shop_function/item_management_all_function.js"></script>
