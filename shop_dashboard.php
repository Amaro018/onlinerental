...
<body>
	<div id="chatbox_data" class="row no-gutters"></div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-8 col-lg-10" id="shop_dashboard" style="background-color: rgba(0, 123, 255, 0.1)"></div>
			<!-- 9, 15, 126, 0.8 -->
		</div>
	</div>
	
	<script src="function/shop_dashboard/shop_function/dashboard_all_function.js"></script>
...
<script>
	...
	// 	detalye.push({
	// 		label: res.arr[a]+' star',
	// 		borderColor: color_arr[a],
	// 		backgroundColor: color_arr[a],
	// 		data: [res.count[a], res.count[a], res.count[a]],
	// 		fill: false,
	// 	});
	// }
</script>
